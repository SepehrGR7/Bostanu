...
$(function () {
   ...
   $underline
      ...
      .css(
         'left',
         $('.scroll-nav-current').position().left + $('.scroll-nav-current').width() / 2 - $underline.width() / 2
      )
      .data(
         'origLeft',
         $('.scroll-nav-current').position().left + $('.scroll-nav-current').width() / 2 - $underline.width() / 2
...
$(function () {
   ...
   const $underline = $('.skills-underline');

   $underline
      .css('left', $('.active-skill').position().left + $('.active-skill').width() / 2 - $underline.width() / 2)
      .data('origLeft', $('.active-skill').position().left + $('.active-skill').width() / 2 - $underline.width() / 2);

   $('#skills .skills-nav li').hover(
      function () {
         $el = $(this);
         leftPos = $el.position().left;
         $underline.stop().animate({
